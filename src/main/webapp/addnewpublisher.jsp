...
<head>
  ...
  <title>BOOKSTORE ONLINE | Add New Publisher</title>
...
<div id="wrapper">
 ...
 -->
  ...
  <!-- Content Wrapper -->
  <div class="container">
    <p style="font-size: 40px; color: #0b0b0b">ADD NEW PUBLISHER</p>
    <form action="add" method="post">
      <input type="hidden" name="action" value="addnewpublisher">
      <label for="fname">Publisher Name</label>
      <input type="text" id="fname" name="publisherName" placeholder="Type publisher name..">
