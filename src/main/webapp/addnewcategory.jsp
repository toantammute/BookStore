...
<head>
    ...
    <title>BOOKSTORE ONLINE | Add New Category</title>
...
<div id="wrapper">
    ...
    <!-- Content Wrapper -->
    <div class="container">
        <p style="font-size: 40px; color: #0b0b0b">ADD NEW CATEGORY</p>
        <form action="add" method="post">
            <input type="hidden" name="action" value="addnewcategory">
            <label for="fname">Category Name</label>
            <input type="text" id="fname" name="categoryName" placeholder="Type category name..">
