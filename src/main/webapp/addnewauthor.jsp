...
<head>
  ...
  <title>BOOKSTORE ONLINE | Add New Author</title>
...
<div id="wrapper">
 ...
 -->
  ...
  <!-- Content Wrapper -->
  <div class="container">
    <p style="font-size: 40px; color: #0b0b0b">ADD NEW AUTHOR</p>
    <form action="add" method="post">
      <input type="hidden" name="action" value="addnewauthor">
      <label for="fname">Author Name</label>
      <input type="text" id="fname" name="authorName" placeholder="Type author name..">
